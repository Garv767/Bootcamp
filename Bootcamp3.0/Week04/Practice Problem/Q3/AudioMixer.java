public class AudioMixer {
    ...
    public AudioMixer(String mixerModel, int numberOfChannels, boolean hasBluetoothConnectivity, double maxVolumeDecibels) {
        ...
        this.deviceCount = 0;
        System.out.println("AudioMixer constructor executed: " + mixerModel + " (" + numberOfChannels + " channels, Bluetooth: " + (hasBluetoothConnectivity ? "Enabled" : "Disabled") + ", Max Volume: " + maxVolumeDecibels + " dB)");
    }
    ...
    public static void main(String[] args) {
        ...
        AudioMixer mixer2 = new AudioMixer("MiniMix-4", 4);
        ...
        AudioMixer mixer4 = new AudioMixer("ProMix-16", 16, true, 135.0);
        ...
        mixer3.connectDevice("Smartphone");
