public class GameController {
    ...
    public static void main(String[] args) {
        ...
        GameController customController = new GameController(
                "ProGamer", "Bluetooth", false, 75, 2.5);
        System.out.println("\nCustom Controller:");
        ...
        GameController simpleController = new GameController("ArcadeMaster", "Wireless");
        System.out.println("\nSimple Controller:");
        ...
        System.out.println("Default vs Custom: " +
                (defaultController.sensitivity == customController.sensitivity ? "Same sensitivity" : "Different sensitivity"));
        System.out.println("Simple vs Custom: " +
                (simpleController.connectionType.equals(customController.connectionType) ? "Same connection" :
